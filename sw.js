const CACHE_NAME = "day-manager-cache-v9";
const CORE_ASSETS = [
  ...
  "./js/prompt.js", "./js/quick-add.js", "./js/render.js", "./js/state.js", "./js/study-manager.js", "./js/time.js", "./js/ui-feedback.js", "./js/utils.js"
];
